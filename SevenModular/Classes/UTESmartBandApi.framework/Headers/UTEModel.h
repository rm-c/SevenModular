...
/**
 *  ①The sports items (UTEDeviceSportModeTramp, UTEDeviceSportModeRunning, UTEDeviceSportModeMountaineering, UTEDeviceSportModeTreadmill.), accumulate the number of steps and calories generated, and then add them to the main interface of the device to display the number of steps and calories.
