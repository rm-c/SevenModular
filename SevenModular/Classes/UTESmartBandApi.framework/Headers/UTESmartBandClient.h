 ...
 *
 *  @param weatherCode e.g. 101 ,See https://dev.qweather.com/docs/start/icons
 *
 ...
 *
 *  Note:If isHasCustomDataBluetooth5=YES,The length cannot exceed UTEModelDevices.maxBluetooth5DataLength.
 *
 ...
 *
 *  @param  count How many times the device vibrates. Range (1~20)
 *  It is recommended 2 times, too much vibration will reduce the battery power.
 *
 *
 *  @return It sends successfully or fails
 */
 ...
 *  if there is UTEModelSportHRMData(sportModel is UTEDeviceSportModeRunning/UTEDeviceSportModeCycling/UTEDeviceSportModeMountaineering/UTEDeviceSportModeTramp) data, then use their UTEModelSportHRMData.timeStart to use method syncDataGPS:UTEModelSportHRMData.timeStart .
 *
 ...
 *  When Sport model is UTEDeviceSportModeTramp/UTEDeviceSportModeRunning/UTEDeviceSportModeCycling ,
 ...
 *  Note:4 Clocks must be filled
 *
 *  @return It sends successfully or fails
 */
- (BOOL)setCustomBloodAlerm:(NSArray<UTEModelCustomBloodClock *> *_Nonnull)array;
 ...
 *  @param dataType   Only fill in UTEDeviceSportModeTramp/UTEDeviceSportModeRunning/UTEDeviceSportModeCycling
